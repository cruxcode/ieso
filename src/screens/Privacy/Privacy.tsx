		...
		<div style={{ textAlign: "left" }}>
			...
			<ul>
				...
				<li>
					...
					"Our" in this Agreement) refers to ieso.
				</li>
				<li>
				...
				<li>
					Website refers to ieso, accessible from https://ieso.help
				</li>
				...
				<li>
					...
					used. Third-party Social Media Service refers to any website
			...
			<ul>
				<li>
					Token: this is a URL-safe JSON web token (JWT) designed to
					Your session after login with username and credentials.
				</li>
				<li>
